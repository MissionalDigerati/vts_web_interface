...
<div class="users join form">
	<?php echo $this->element('../Users/_manage_button', array('user'	=>	$this->request->data, 'pull_right'	=>	true)); ?>
<?php echo $this->Form->create('User', array('inputDefaults' => $this->TwitterBootstrap->inputDefaults(), 'class' => 'form-horizontal'));?>
	<fieldset>
		<legend><?php echo __('Edit User'); ?></legend>
		<?php echo $this->element('../Users/_admin_form', array('method'	=>	'EDIT', 'isActive'	=>	$isActive)); ?>
